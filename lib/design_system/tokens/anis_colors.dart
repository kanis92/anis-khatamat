...
class AnisPalette {
  ...
  /// Fond ivoire ANIS — source de vérité (#FAF8F5).
  ...
  /// Vert très foncé historique (AppBar legacy, overlays) — #0B2E25.
  ///
  /// Distinct de [green800]. Conservé tel quel en DS-01 pour zéro delta visuel
  /// sur les écrans non migrés.
  static const Color green825 = Color(0xFF0B2E25);
  ...
  /// Parchemin — fond arabe / zones Mushaf UI — #F5F0E8.
...
class AnisColors extends ThemeExtension<AnisColors> {
  ...
  AnisColors lerp(ThemeExtension<AnisColors>? other, double t) {
    ...
    return AnisColors(
      ...
      actionSecondarySurface: c(
        actionSecondarySurface,
        other.actionSecondarySurface,
      ),
      ...
      actionDisabledSurface: c(
        actionDisabledSurface,
        other.actionDisabledSurface,
      ),
      ...
      hizbInProgressSurface: c(
        hizbInProgressSurface,
        other.hizbInProgressSurface,
      ),
